// Material Catalog - Danh mục vật liệu chuẩn hóa
...
export interface CatalogMaterial {
  ...
  co2Factor: number; // kg CO2e per kg material
...
export interface ProductMaterialInput {
  ...
  requestId?: string; // Link to material_requests if user_other
  notes?: string;
}
...
// Proxy EF lookup for unknown materials
export function getProxyEmissionFactor(
  ...
  // Default proxy based on application
...
// Get materials that need special handling warnings
...
// Calculate confidence level based on materials
...
// Material type labels in Vietnamese
...
// Material family labels in Vietnamese
